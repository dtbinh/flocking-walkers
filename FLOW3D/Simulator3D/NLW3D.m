...
%
% 2012-2013 Ath. Kehagias and L. Eleftheriou
%
...
fprintf(fid,'fh1=figure(998); clf; set(fh1,''NumberTitle'',''off''); set(fh1,''Name'',''Dynamic Trajectories''); rotate3d on;\n');
fprintf(fid,'fh2=figure(999); clf; set(fh2,''NumberTitle'',''off''); set(fh2,''Name'',''Static Trajectories'')\n');

fprintf(fid,['fname=''' fname1 ''';\n']);
fprintf(fid,'addpath ../Simulator3D\n');
...
fprintf(fid,'[x,y,z,p,q,r]=ActSim(pars);\n');
fprintf(fid,'figure(999); plot3(x(1:pars.T-1,:),y(1:pars.T-1,:),z(1:pars.T-1,:));grid on;\n');
fclose(fid);
