...
%-------------------------------------------- RULES PARAMETERS -------------------------------------------
w(1)=0.0; 	pars.rules(1).rule='u=DirOfActor(m,n);';
w(2)=0.0; 	pars.rules(2).rule='u=DirOfField(FH,n);';
w(3)=1; 	pars.rules(3).rule='u=DirOfGroup([ones(5,5) zeros(5,10);zeros(5,5) ones(5,5) zeros(5,5);zeros(5,10) ones(5,5)],n);';
w(4)=0.0; 	pars.rules(4).rule='u=DirOfHood(d,ang,n);';
w(5)=0.0; 	pars.rules(5).rule='u=DirOfNearest(n);';
w(6)=0.0; 	pars.rules(6).rule='u=DirToActor(m,n);';
...
w(12)=0.5; 	pars.rules(12).rule='u=AvoidNearestActor(5,n);';
w(13)=0.0; 	pars.rules(13).rule='u=Flock(davoid,dhood,ang,n);';
w(14)=0.0; 	pars.rules(14).rule='u=CuckerSmale(b,n);';
w(15)=0.0; 	pars.rules(15).rule='u=FollowWayPoints(WP,d,doff,n);';
